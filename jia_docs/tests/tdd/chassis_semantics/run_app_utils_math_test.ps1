...
$testSrc = Join-Path $testsDir 'test_app_utils_math.cpp'

function Invoke-AppUtilsMathTest {
    param(
...
Invoke-AppUtilsMathTest -BackendName 'std' -BackendDefine 'JIA_APP_MATH_MODE=JIA_APP_MATH_MODE_STD'
Invoke-AppUtilsMathTest -BackendName 'dsp' -BackendDefine 'JIA_APP_MATH_MODE=JIA_APP_MATH_MODE_DSP'
