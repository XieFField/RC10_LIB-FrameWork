...
截至 `2026-06-24`，当前 RC10 底盘主线应按“2026-06-24 homing auto-retry / X-Park priority brake / debug 接口收口 + 2026-06-09 path / yaw / homing / build 主线背景”来理解。当前状态可概括为：
...
- `chassis_semantics` host 主入口当前已知状态为：`run_main.ps1` 通过，`run_slim_smoke.ps1` 通过，最新同步数字为 `210/210 passed` 与 `sizeof(Chassis)=2856`。
