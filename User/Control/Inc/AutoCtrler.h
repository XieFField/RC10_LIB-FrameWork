...
const Point2D MapNum_RealPos[30] = {
    {0.6, 3.0, 0}, {1.8, 3.0, 0}, {3.0, 3.0, 0}, {4.2, 3.0, 0}, {5.4, 3.0, 0},
    {0.6, 4.2, 0}, {1.8, 4.2, 0}, {3.0, 4.2, 0}, {4.2, 4.2, 0}, {5.4, 4.2, 0},
    {0.6, 5.4, 0}, {1.8, 5.4, 0}, {3.0, 5.4, 0}, {4.2, 5.4, 0}, {5.4, 5.4, 0},
    {0.6, 6.6, 0}, {1.8, 6.6, 0}, {3.0, 6.6, 0}, {4.2, 6.6, 0}, {5.4, 6.6, 0},
    {0.6, 7.8, 0}, {1.8, 7.8, 0}, {3.0, 7.8, 0}, {4.2, 7.8, 0}, {5.4, 7.8, 0},
    {0.6, 9.0, 0}, {1.8, 9.0, 0}, {3.0, 9.0, 0}, {4.2, 9.0, 0}, {5.4, 9.0, 0}
};
