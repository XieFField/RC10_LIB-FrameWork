...
void GO_MotorDemo::init()
{
    ...
    // 初始化PID参数
    GO_Motor_1.pid_init(Go_speed_pid_params, 1000.0f, Go_angle_pid_params, 0.0f);
...
void GO_MotorDemo::loop()
{
    ...
    last_time = time_now;
    debug_uart.printf_DMA("%f,%f,%f,%f\r\n",GO_Motor_1.getTargetRPM(), GO_Motor_1.getRPM(), GO_Motor_1.getTargetTotalAngle(), GO_Motor_1.getTotalAngle());
