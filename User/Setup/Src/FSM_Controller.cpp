...
int8_t test_led = 0;
extern Serial1Protocol* 	m_serial1;
    ...
    switch(airjoy_data_.SWF)
    {
        ...
        case 0x01:
        {
            ...
            else if(airjoy_data_.SWB == 0x01)
            {
                ...
                arm_setup->setArmStatus(ARM_SEMI_AUTO_CONTROL);
            }
            break;
        }
        ...
        case 0x02:
        {
            ...
            else if(airjoy_data_.SWB == 0x01) //半自动
            {
