...
/*--------------------------------------准备模式已就绪，等待底盘就位--------------------------------------*/
    ...
    if(auto_ctrl_.auto_state_bool_S.is_matching&&auto_ctrl_.flag.is_prepared) //如果已经在对位了
    {
		...
		this->setArm_angle(89.0f);
		auto_ctrl_.flag.is_arm_reset=true;
		if(abs(current_pos_.arm_pos_-89.0f)<1.0f)
		{
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
    if(auto_ctrl_.auto_state_bool_S.is_matching&&auto_ctrl_.flag.is_prepared) //如果已经在对位了
    {
		...
		this->setArm_angle(89.0f);
		if(abs(current_pos_.arm_pos_-89.0f)<1.0)
		{
...
//                        }
            ...
            {   
                ...
                this-setArm_angle(0.2f); //将arm打到竖直位置
