...
void chassis_motorInit()
{
   ...
   // 注册电机组到总线
   onim_demo.registerWheelMotor(0, &wheel_motor1);
   onim_demo.registerWheelMotor(1, &wheel_motor2); 
   onim_demo.registerWheelMotor(2, &wheel_motor3);
   onim_demo.registerWheelMotor(3, &wheel_motor4);
