...
namespace jia
{
    ...
    public:
        ...
        struct Data
        {
            ...
            f32 w1_omega;     // 轮子1的角速度，单位：rad/s，主单位
            f32 w1_omega_rpm; // 轮子1的角速度，单位：rpm，从单位
            f32 w2_omega;     // 轮子2的角速度，单位：rad/s，主单位
            f32 w2_omega_rpm; // 轮子2的角速度，单位：rpm，从单位
            f32 w3_omega;     // 轮子3的角速度，单位：rad/s，主单位
            f32 w3_omega_rpm; // 轮子3的角速度，单位：rpm，从单位
        };
    ...
    private:
        ...
        f32 vel_x_radio = 1.0f;           // x轴速度比例系数
        f32 vel_y_radio = 1.0f;           // y轴速度比例系数
        f32 omega_z_radio = 1.0f;         // z轴角速度比例系数
        ...
        f32 max_omega_z = 0.0f;     // 最大z轴角速度，单位：rad/s，主单位
        f32 max_omega_deg_z = 0.0f; // 最大z轴角速度，单位：deg/s，从单位
