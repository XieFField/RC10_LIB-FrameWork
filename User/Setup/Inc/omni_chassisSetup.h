...
private:
    ...
    Speedplanner_1D_Param_Config path_param_CB_ = {.maxAcc = 10.0f, .maxDec = 1.0f, .maxJerk = 0.0f, .maxSpeed = 1.5f, .initialSpeed = 0.2f, .finalSpeed = 0.0f, .startPos = 0.0f, .targetPos = 0.0f, .deadzone = 0.1f};     // 夹杆流程速度规划参数。
