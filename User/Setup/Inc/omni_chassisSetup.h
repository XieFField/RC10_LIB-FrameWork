...
public:
    ...
    void setChassisStatus(CHASSIS_Status_E status)
    {
        ...
        {
            // ÍË³öÊÓ¾õµ÷ÊÔÊ±£¬ÖØÖÃ¸ß¶ÈËø¶¨×´Ì¬£¬±ãÓÚÏÂ´ÎÖØÐÂÖ´ÐÐcase -1¡£
    ...
    {
        // ÓÉFSM²ã´«Èëµ±Ç°launchÎ»ÖÃ£»Ïà»úzÔÚCHASSIS_CAMERA_DEBUG·ÖÖ§ÇÅ½Óµ½launchËø¶¨×´Ì¬»ú¡£
...
private:
    ...
    int8_t debug_launch_state_ = -1; // -1: ¶ÁÈ¡²¢Ëø¶¨Ò»´Î, 0: ³ÖÐø±£³Ö
