...
bool ArmSetup::state_alignStillness(int targetKFS)
{
    ...
    {
        //X方向主要对应的1 2 3号 和 10 11 12号
        //Y方向主要对应的1 4 7 10号和3 6 9 12号
        case MF_AutoCtrler::Direction_E::Positive_X:
        {
            break;
        }

        case MF_AutoCtrler::Direction_E::Negative_X:
        {
            break;
        }

        case MF_AutoCtrler::Direction_E::Positive_Y:
        {
            
            break;
        }

        case MF_AutoCtrler::Direction_E::Negative_Y:
        {
            break;
        }
        default:
